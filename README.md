...
![LivePreview拡張機能](/LivePreview拡張.jpeg)

インストールが終わったら、`samples/skeleton/index.html`を開いてください。右上にアイコンが追加されているのがわかりますか？

![LivePreviewアイコン](/LivePreviewアイコン.jpeg)

それをクリックしてみてください。もう一つ画面が出てくると思います。

![LivePreview起動画面](/LivePreview起動画面.jpeg)

もし、見にくければブラウザで開くこともできます。

![LivePreviewメニュー](/LivePreviewのメニュー.jpeg)

では、この状態で`samples/skeleton/my-p5.js`を開いてコードを編集し、保存してみましょう！すぐさま、画面に反映されていることがわかります。

![LivePreviewが動いているところ](/LivePreviewが動いている.jpeg)
